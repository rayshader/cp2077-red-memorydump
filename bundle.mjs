...
// Script to bundle RedMemoryDump to dist/ and release it as an archive.
//
// Requirements:
...
const PLUGIN_SCRIPT_PATH = `scripts/redscript/${PLUGIN_NAME}/`;
const PLUGIN_CET_SCRIPT_PATH = `scripts/cet/`;
...
const BUNDLE_CET_SCRIPT_PATH = `${BUNDLE_PATH}bin/x64/plugins/cyber_engine_tweaks/mods/${PLUGIN_NAME}/`;
...
fs.mkdirSync(BUNDLE_CET_SCRIPT_PATH, { recursive: true });
...
fs.cpSync(PLUGIN_LICENSE, `${BUNDLE_CET_SCRIPT_PATH}/${PLUGIN_LICENSE}`);

// Copy CET scripts.
fs.cpSync(PLUGIN_CET_SCRIPT_PATH, BUNDLE_CET_SCRIPT_PATH, { recursive: true });
